...
class CreateDocument:
    ...
    def set_file_data(self, initial_data):
        for file_name_without_extension in sorted(initial_data.keys()):
            ...
            # p = row_cells[0].add_paragraph(file_name_without_extension.strip())
...
args = (
    ('My 1', r"C:\Users\Parth\Desktop\Currently Working\docs_project\abc"),
    ('My 2', r"C:\Users\Parth\Desktop\Currently Working\docs_project\qwer"),
    ('My 3', r"C:\Users\Parth\Desktop\Currently Working\docs_project\rtrt"),
)
data = {}
for folder_name, folder_path in args:
    ...
    for file in files:
        ...
        data[file_name_without_ext] = data.get(file_name_without_ext, []) + [[folder_name, os.path.join(folder_path, file)]]


width = Inches(2.8)

current_time = datetime.now().time()
create_docs = CreateDocument(filename=f'testing_{current_time.hour}_{current_time.minute}_{current_time.second}.docx', image_width=width)
